...
export const AnimaButtonCloseLarge = ({ className }: Props): JSX.Element => {
  return (
    <svg
      className={`anima-button-close-large ${className}`}
      fill="none"
      height="56"
      viewBox="0 0 56 56"
      width="56"
    ...
    >
      ...
      <mask className="mask" fill="white" id="path-1-inside-1_2190_4305">
        <path
          className="path"
      ...
      <path
        ...
        fill="black"
        mask="url(#path-1-inside-1_2190_4305)"
      />
    </svg>
  );
};