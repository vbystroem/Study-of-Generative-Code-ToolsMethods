      ...
      <View style={styles.iphoneSe92NySeEnITa}>
        <View style={[styles.aktivitetsfrslag, styles.frameFlexBox1]}>
          <View style={[styles.frame, styles.frameFlexBox1]}>
            <Text
              style={[styles.villDuLgga, styles.cyklaFlexBox]}
              numberOfLines={1}
            >
            ...
            <View style={[styles.frame, styles.frameFlexBox1]}>
              <View style={[styles.frame2, styles.frameFlexBox1]}>
                ...
                <Text
                  style={[styles.cykla, styles.cyklaFlexBox]}
                  numberOfLines={1}
                >
                  Cykla
                </Text>
              ...
              <Frame
                bildobjektXstort={require("../assets/bildobjekt-xstort.png")}
              />
            </View>
          </View>
          <View style={[styles.frame3, styles.frameFlexBox]}>
            ...
            >
              <Text
                style={[styles.nejInteDen, styles.cyklaFlexBox]}
                numberOfLines={1}
              >
                Nej, inte den
              </Text>
...
export default IPhoneSE92NYSeEnITa1;
