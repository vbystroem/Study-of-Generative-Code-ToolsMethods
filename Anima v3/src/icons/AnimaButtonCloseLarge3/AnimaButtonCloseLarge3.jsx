...
export const AnimaButtonCloseLarge3 = ({ className }) => {
  return (
    <svg
      className={`anima-button-close-large-3 ${className}`}
      fill="none"
      height="56"
      viewBox="0 0 56 56"
      width="56"
    ...
    >
      <mask className="mask" fill="white" id="path-1-inside-1_2244_76">
        <path
          className="path"
      ...
      <path
        ...
        fill="black"
        mask="url(#path-1-inside-1_2244_76)"
      />
    </svg>
  );
};
